  ...
  return (
    <section className="bg-gray-50 dark:bg-darkBlue1">
      ...
      <div className="container mx-auto pb-32 px-6">
        {/* content list */}
        <ul className="grid grid-cols-1 gap-y-24 md:grid-cols-2 md:gap-y-28">
          {/* item 1 */}
          <li className="text-center max-w-md mx-auto">
            {/* icon */}
            <svg
              className="mx-auto"
              width="83"
            ...
            {/* title */}
            <h5 className="mt-10 mb-2 font-extrabold text-xl tracking-wider">
